...
######Constant Area#######
    ...
    fn0 = f"{folder}/{GLM_name}fBf1n{n}p{p}B{B}r{r}{numepochs}.csv"
    fn1 = f"{folder}/{GLM_name}sdf1nn{n}p{p}B{B}r{r}{numepochs}.csv"
    fn2 = f"{folder}/{GLM_name}sdcrtf1nn{n}p{p}B{B}r{r}{numepochs}.csv"
