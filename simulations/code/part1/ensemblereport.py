...
PATH=folder+'/Ensemble/'
df_E_all_file = f"{PATH}/{GLM_name}En{n}p{p}.csv"
df_std_all_file = f"{PATH}/{GLM_name}stdn{n}p{p}.csv"
df_lower_all_file = f"{PATH}/{GLM_name}lowern{n}p{p}.csv"
df_upper_all_file = f"{PATH}/{GLM_name}uppern{n}p{p}.csv"



df_E  = pd.read_csv(df_E_all_file, header=None)
df_std  = pd.read_csv(df_std_all_file, header=None)
